...
- [ ] Полный прогон всех 10 регионов запущен (run 28998048493, тег
  maps-2026-07-09) — сборка по умолчанию и по cron собирает ВСЕ округа
  (пустой only), ждём результата
